/**
 * \file protocol/vcblockchain_protocol_encode_req_block_get.c
 *
 * \brief Encode a block get request into a buffer.
 *
    ...
    uint32_t offset, const vpr_uuid* block_id)
{
    ...
    u32arr[0] = htonl(PROTOCOL_REQ_ID_BLOCK_BY_ID_GET);
