/**
 * \file protocol/vcblockchain_protocol_encode_req_connection_close.c
 *
 * \brief Encode a connection close request into a buffer.
 *
    ...
    vccrypt_buffer_t* buffer, allocator_options_t* alloc_opts, uint32_t offset)
{
    ...
    u32arr[0] = htonl(PROTOCOL_REQ_ID_CLOSE);
