/**
 * \file
 * test/protocol/test_vcblockchain_protocol_decode_resp_block_id_by_height_get.cpp
 *
 * Unit tests for decoding the block id by height get response.
 *
 ...
 */
TEST(test_vcblockchain_protocol_decode_resp_block_id_by_height_get, parameters)
{
    const uint8_t EXPECTED_PAYLOAD[4] = { 0x00, 0x01, 0x02, 0x03 };
    size_t EXPECTED_PAYLOAD_SIZE = sizeof(EXPECTED_PAYLOAD);
    protocol_resp_block_id_by_height_get resp;
 ...
 */
TEST(
    test_vcblockchain_protocol_decode_resp_block_id_by_height_get, payload_size)
{
    const uint8_t EXPECTED_PAYLOAD[4] = { 0x00, 0x01, 0x02, 0x03 };
    size_t EXPECTED_PAYLOAD_SIZE = sizeof(EXPECTED_PAYLOAD);
    protocol_resp_block_id_by_height_get resp;
 ...
 */
TEST(test_vcblockchain_protocol_decode_resp_block_id_by_height_get, happy_path)
{
    ...
    EXPECT_EQ(PROTOCOL_REQ_ID_BLOCK_ID_BY_HEIGHT_GET, resp.request_id);
