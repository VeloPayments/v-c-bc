...
TEST_SUITE(test_vcblockchain_protocol_encode_resp_txn_prev_id_get);
...
TEST(happy_path)
{
    ...
    TEST_EXPECT(htonl(PROTOCOL_REQ_ID_TRANSACTION_ID_GET_PREV) == uarr[0]);
    ...
    TEST_EXPECT(0 == memcmp(barr, &EXPECTED_TXN_ID, sizeof(EXPECTED_TXN_ID)));
