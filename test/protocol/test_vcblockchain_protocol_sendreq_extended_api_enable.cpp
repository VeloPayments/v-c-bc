/**
 * \file
 * test/protocol/test_vcblockchain_protocol_sendreq_extended_api_enable.cpp
 *
 * Unit tests for writing an extended API enable request to a server socket.
 *
 ...
 * Test the happy path.
 */
TEST(test_vcblockchain_protocol_sendreq_extended_api_enable, happy_path)
{
    psock* sock;
    ...
    EXPECT_EQ(PROTOCOL_REQ_ID_EXTENDED_API_ENABLE, req.request_id);
