/**
 * \file
 * test/protocol/test_vcblockchain_protocol_sendreq_extended_api.cpp
 *
 * Unit tests for writing an extended API request to a server socket.
 *
 ...
 * Test the happy path.
 */
TEST(test_vcblockchain_protocol_sendreq_extended_api, happy_path)
{
    psock* sock;
    ...
    vpr_uuid entity_id = { .data = {
        0x1a, 0x55, 0x51, 0xab, 0x8c, 0x9b, 0x46, 0x56,
        0xa4, 0x15, 0x76, 0xa5, 0x1d, 0xbb, 0x85, 0x51 } };
    vpr_uuid verb_id = { .data = {
        0xdd, 0x11, 0x56, 0xa2, 0x16, 0x8d, 0x42, 0x71,
        0x91, 0xa4, 0xc2, 0x47, 0x2c, 0x9b, 0x79, 0x7f } };
    ...
    memset(request_body.data, 0xef, request_body.size);
