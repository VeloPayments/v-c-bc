/**
 * \file
 * test/protocol/test_vcblockchain_protocol_encode_req_connection_close.cpp
 *
 * Unit tests for encoding the connection close request.
 *
 ...
 */
TEST(test_vcblockchain_protocol_encode_req_connection_close, parameter_check)
{
 ...
 */
TEST(test_vcblockchain_protocol_encode_req_connection_close, happy_path)
{
    const uint32_t EXPECTED_OFFSET = 97;
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
    ...
    EXPECT_EQ(htonl(PROTOCOL_REQ_ID_CLOSE), u32arr[0]);
