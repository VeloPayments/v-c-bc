 ...
 */
TEST(
    test_vcblockchain_protocol_decode_req_extended_api_enable,
    parameter_checks)
{
 ...
 */
TEST(test_vcblockchain_protocol_decode_req_extended_api_enable, payload_size)
{
    const uint8_t EXPECTED_PAYLOAD[4] = { 0x00, 0x01, 0x02, 0x03 };
    size_t EXPECTED_PAYLOAD_SIZE = sizeof(EXPECTED_PAYLOAD);
    protocol_req_extended_api_enable req;
 ...
 */
TEST(test_vcblockchain_protocol_decode_req_extended_api_enable, happy_path)
{
