/**
 * \file test/protocol/test_vcblockchain_protocol_sendreq_txn_prev_id_get.cpp
 *
 * Unit tests for writing the txn prev id get request to a server socket.
 *
 ...
 * Test the happy path.
 */
TEST(test_vcblockchain_protocol_txn_prev_id_get, happy_path)
{
    ssock sock;
