...
TEST_SUITE(test_vcblockchain_protocol_encode_req_artifact_first_txn_id_get);
...
TEST(happy_path)
{
    ...
    TEST_EXPECT(
        htonl(PROTOCOL_REQ_ID_ARTIFACT_FIRST_TXN_BY_ID_GET) == u32arr[0]);
    ...
    TEST_EXPECT(0 == memcmp(barr, &EXPECTED_ARTIFACT_ID, 16));
