 ...
 */
TEST(test_vcblockchain_protocol_encode_resp_extended_api_enable, parameters)
{
...
TEST(test_vcblockchain_protocol_encode_resp_extended_api_enable, happy_path)
{
    const uint32_t EXPECTED_OFFSET = 26;
    const uint32_t EXPECTED_STATUS = 11;
    allocator_options_t alloc_opts;
    ...
    EXPECT_EQ(htonl(PROTOCOL_REQ_ID_EXTENDED_API_ENABLE), uarr[0]);
