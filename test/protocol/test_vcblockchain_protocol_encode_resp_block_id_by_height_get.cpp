...
TEST_SUITE(test_vcblockchain_protocol_encode_resp_block_id_by_height_get);
...
TEST(happy_path)
{
    ...
    TEST_EXPECT(htonl(PROTOCOL_REQ_ID_BLOCK_ID_BY_HEIGHT_GET) == uarr[0]);
    ...
    TEST_EXPECT(
        0 == memcmp(barr, &EXPECTED_BLOCK_ID, sizeof(EXPECTED_BLOCK_ID)));
