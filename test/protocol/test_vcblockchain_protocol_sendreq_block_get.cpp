/**
 * \file test/protocol/test_vcblockchain_protocol_sendreq_block_get.cpp
 *
...
TEST_SUITE(test_vcblockchain_protocol_block_get);
...
TEST(happy_path)
{
    ...
    TEST_EXPECT(PROTOCOL_REQ_ID_BLOCK_BY_ID_GET == req.request_id);
