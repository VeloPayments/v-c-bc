/**
 * \file test/protocol/test_vcblockchain_protocol_sendreq_txn_get.cpp
 *
 * Unit tests for writing the transaction get request to a server socket.
 *
 ...
 * Test the happy path.
 */
TEST(test_vcblockchain_protocol_txn_get, happy_path)
{
    psock* sock;
    ...
    EXPECT_EQ(PROTOCOL_REQ_ID_TRANSACTION_BY_ID_GET, req.request_id);
