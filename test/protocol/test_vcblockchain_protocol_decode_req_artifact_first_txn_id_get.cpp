/**
 * \file
 * test/protocol/test_vcblockchain_protocol_decode_req_artifact_first_txn_id_get.cpp
 *
 * Unit tests for decoding the artifact first txn id get request.
 *
 ...
 */
TEST(
    test_vcblockchain_protocol_decode_req_artifact_first_txn_id_get,
    parameter_check)
{
 ...
 */
TEST(
    test_vcblockchain_protocol_decode_req_artifact_first_txn_id_get, happy_path)
{
    ...
    EXPECT_EQ(PROTOCOL_REQ_ID_ARTIFACT_FIRST_TXN_BY_ID_GET, req.request_id);
