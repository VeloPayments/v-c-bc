/**
 * \file
 * test/protocol/test_vcblockchain_protocol_decode_resp_artifact_first_txn_id_get.cpp
 *
 * Unit tests for decoding the artifact first txn id get response.
 *
...
TEST_SUITE(test_vcblockchain_protocol_decode_resp_artifact_first_txn_id_get);
...
TEST(happy_path)
{
    ...
    TEST_EXPECT(
        PROTOCOL_REQ_ID_ARTIFACT_FIRST_TXN_BY_ID_GET == resp.request_id);
