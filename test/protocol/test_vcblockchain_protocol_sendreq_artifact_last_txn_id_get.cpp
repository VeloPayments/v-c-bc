/**
 * \file test/protocol/test_vcblockchain_protocol_sendreq_artifact_last_txn_id_get.cpp
 *
 * Unit tests for writing the artifact last txn id get request to a server socket.
 *
 ...
 * Test the happy path.
 */
TEST(test_vcblockchain_protocol_artifact_last_txn_id_get, happy_path)
{
    psock* sock;
